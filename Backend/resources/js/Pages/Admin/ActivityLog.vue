  ...
  <DocsLayout wide>
    ...
    <div class="space-y-8 max-w-5xl mx-auto">
      ...
      <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 class="text-3xl font-bold tracking-tight text-white mb-1">System Activity Log</h1>
          <p class="text-gray-500 text-sm">Comprehensive audit trail of all documentation changes and system events.</p>
        </div>
        <div class="flex items-center gap-2">
            <div class="px-3 py-1.5 rounded-lg bg-[#161616] border border-[#262626] text-[11px] font-bold text-gray-400 flex items-center gap-2">
      ...
      <div class="flex items-center justify-between gap-4">
          <div class="relative flex-1 max-w-sm">
            ...
            <input 
                ...
                class="w-full bg-[#161616] border-[#262626] rounded-xl pl-10 pr-4 py-2 text-sm text-white placeholder-gray-600 focus:border-indigo-500 focus:ring-indigo-500 transition-all font-medium"
            >
          </div>
          
          <div class="flex items-center gap-3">
              <button class="p-2 rounded-lg bg-[#161616] border border-[#262626] text-gray-500 hover:text-white transition-all">
                  <Filter class="w-4 h-4" />
              </button>
              <button class="p-2 rounded-lg bg-[#161616] border border-[#262626] text-gray-500 hover:text-white transition-all" @click="$inertia.reload()">
      ...
      <div class="relative space-y-4">
          ...
          >
            <!-- Timeline Node -->
            <div class="absolute left-[21px] top-6 w-2.5 h-2.5 rounded-full bg-[#161616] border-2 border-indigo-500 z-10 group-hover:scale-125 transition-transform shadow-[0_0_8px_rgba(99,102,241,0.5)]" />

            <div class="bg-[#161616] border border-[#262626] rounded-2xl p-5 hover:border-indigo-500/30 transition-all shadow-lg hover:shadow-indigo-500/5">
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div class="space-y-1">
                            <div class="flex flex-wrap items-center gap-x-2 gap-y-1">
                                <span class="text-sm font-bold text-white">{{ activity.user }}</span>
          ...
          <!-- Empty State -->
          <div v-if="filteredActivities.length === 0" class="flex flex-col items-center justify-center py-20 bg-[#161616] border border-[#262626] border-dashed rounded-3xl">
      ...
      <!-- Pagination -->
      <div v-if="props.activities.last_page > 1" class="flex items-center justify-between bg-[#161616] border border-[#262626] p-4 rounded-2xl shadow-xl">
